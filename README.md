...
This project DOES NOT make use of any deep learning technique, relying instead on the more classic instance detection methods provided by OpenCV. To access the second assignment, which instead leverages CNNs and Deep Learning to classify groceries, [click here](https://github.com/AngeloGalav/grocery-image-classification).
